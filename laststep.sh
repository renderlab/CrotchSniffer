...
########################################################################
#################                                    ###################
################# CrotchSniffer Install Script Part2 ###################
#################                                    ###################
########################################################################
#
...
echo -e "\e[0;31m#\e[0m             Finishing CrotchSniffer Installation          \e[0;31m#\e[0m"
echo -e "\e[0;31m#\e[0m                                                           \e[0;31m#\e[0m"
...
echo -e "\e[0;31m[+] After reboot, if your hwclock time (UTC) is incorrect, run /root/CrotchSniffer/fixclock.sh\e[0m"
echo ""
